...
extern "C" {
#endif
void  rmaPropagate0_p_fa_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate0_fa_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate0_f_fa_simv_daidir (UB  * pcode, scalar  val, U  I615, scalar  * I1485, U  did);
void  rmaPropagate0_r_fa_simv_daidir (UB  * pcode);
void  rmaPropagate0_wn_fa_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate1_p_fa_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate1_fa_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate1_f_fa_simv_daidir (UB  * pcode, scalar  val, U  I615, scalar  * I1485, U  did);
void  rmaPropagate1_r_fa_simv_daidir (UB  * pcode);
void  rmaPropagate1_wn_fa_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate2_p_fa_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate2_fa_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate2_f_fa_simv_daidir (UB  * pcode, scalar  val, U  I615, scalar  * I1485, U  did);
void  rmaPropagate2_r_fa_simv_daidir (UB  * pcode);
void  rmaPropagate2_wn_fa_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate3_p_fa_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate3_fa_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate3_f_fa_simv_daidir (UB  * pcode, scalar  val, U  I615, scalar  * I1485, U  did);
void  rmaPropagate3_r_fa_simv_daidir (UB  * pcode);
void  rmaPropagate3_wn_fa_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate4_fa_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate5_fa_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate6_p_fa_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate6_fa_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate6_f_fa_simv_daidir (UB  * pcode, scalar  val, U  I615, scalar  * I1485, U  did);
void  rmaPropagate6_r_fa_simv_daidir (UB  * pcode);
void  rmaPropagate6_wn_fa_simv_daidir (UB  * pcode, scalar  val);
