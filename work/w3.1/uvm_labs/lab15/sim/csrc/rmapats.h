...
void  rmaPropagate5_p_fa_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate5_fa_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate5_f_fa_simv_daidir (UB  * pcode, scalar  val, U  I615, scalar  * I1485, U  did);
void  rmaPropagate5_r_fa_simv_daidir (UB  * pcode);
void  rmaPropagate5_wn_fa_simv_daidir (UB  * pcode, scalar  val);
